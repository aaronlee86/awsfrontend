...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://n0jtsgf0s4.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'Content-Type', 'x-amz-meta-customLabels', 'filetype'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'x-amz-meta-customLabels', 'filetype']),
